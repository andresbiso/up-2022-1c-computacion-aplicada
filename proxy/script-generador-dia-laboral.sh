...
iptables -I INPUT -p tcp -m iprange --src-range 192.168.1.0-192.168.1.255 --dport 22 -j ACCEPT
iptables -I OUTPUT -p tcp -m iprange --dst-range 192.168.1.0-192.168.1.255 --sport 22 -m state --state ESTABLISHED -j ACCEPT
iptables -A INPUT -p tcp --dport 5432 -m iprange --src-range 192.168.1.0-192.168.1.255 -j ACCEPT
iptables -A OUTPUT -p tcp --sport 5432 -m iprange --dst-range 192.168.1.0-192.168.1.255 -j ACCEPT
iptables -A INPUT -p tcp --dport 80 -m iprange --src-range 192.168.1.0-192.168.1.255 -j ACCEPT
iptables -A OUTPUT -p tcp --sport 80 -m iprange --dst-range 192.168.1.0-192.168.1.255 -j ACCEPT
